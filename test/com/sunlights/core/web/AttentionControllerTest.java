...
public class AttentionControllerTest extends BaseTest {
    ...
    @Test
    public void testFindAttentions() {
    ...
    public void testFindAttentionsAndDelete() {
        ...
        try {
            ...
            if (!pageVo.getList().isEmpty()) {
                ...
                FakeRequest cancelAttentionFormRequest = cancelAttentionRequest.withHeader(CONTENT_TYPE, APPLICATION_X_WWW_FORM_URLENCODED)
                        .withFormUrlEncodedBody(paramMap);
    ...
    public void testDepositInterestRate() {
        ...
        Logger.info("[paramMap]" + paramMap);
        FakeRequest formProductsRequest = depositInterestRateRequest.withHeader(CONTENT_TYPE, TestUtil.APPLICATION_X_WWW_FORM_URLENCODED)
                .withFormUrlEncodedBody(paramMap);
