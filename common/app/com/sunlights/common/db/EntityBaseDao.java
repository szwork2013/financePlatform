package com.sunlights.common.db;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.sunlights.common.util.PersistenceUtil;
import com.sunlights.common.util.PropertyFilter;
import com.sunlights.common.util.ReflectionUtils;
...
public class EntityBaseDao {
    ...
    public <T> List<T> findBy(Class<T> entityClass, final String propertyName, final Object value, final PropertyFilter.MatchType matchType) {
        ...
        Predicate predicate = PersistenceUtil.buildPropertyFilterPredicate(entityClass, criteriaBuilder, criteriaQuery, entity, entityType, true,
    ...
    public <T> List<T> find(final Class<T> targetClass, final List<PropertyFilter> filters, final boolean isDistinct) {
        ...
        Predicate predicates[] = PersistenceUtil.buildPropertyFilterPredicates(targetClass, criteriaBuilder, criteriaQuery, entity, entityType,
                isDistinct, filters);
    ...
    protected <T> int countByPropertyFilter(final Class<T> targetClass, final List<PropertyFilter> filters) {
        String countOfQuery = PersistenceUtil.buildQueryStringWithPropertyFilters(true, targetClass, filters);
