 ...
 */
public class CommonDBAppender extends DBAppenderBase<ILoggingEvent> {
    ...
    Map<String, String> mergePropertyMaps(ILoggingEvent event) {
        ...
        Map<String, String> logVoMap = convertLogVoMap(event);
        mergedMap.putAll(logVoMap);

        return mergedMap;
    }

    private Map<String, String> convertLogVoMap(ILoggingEvent event) {
        Map<String, String> logVoMap = new HashMap<String, String>();
    ...
    short buildExceptionStatement(IThrowableProxy tp, short baseIndex,
        ...
        if (commonFrames > 0) {
            ...
            sb.append(CoreConstants.TAB).append("... ").append(commonFrames).append(
                    " com.sunlights.common frames omitted");
            updateExceptionStatement(insertExceptionStatement, sb.toString(),
                    baseIndex++, eventId);
        }
