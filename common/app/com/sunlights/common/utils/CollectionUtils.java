...
public abstract class CollectionUtils extends org.apache.commons.collections.CollectionUtils {
    ...
    /**
     * Find the com.sunlights.common element type of the given Collection, if any.
     *
     * @param collection the Collection to check
     * @return the com.sunlights.common element type, or <code>null</code> if no clear
     * com.sunlights.common type has been found (or the collection was empty)
     */
