...
public interface ActivityConstant {
    ...
    String ACTIVITY_SERVER = "ACTIVITY_SERVER";
    String ACTIVITY_SERVER_PORT = "ACTIVITY_SERVER_PORT";
    String ACTIVITY_IMAGE_PATH = "ACTIVITY_IMAGE_PATH";
    String ACTIVITY_HTML5_PATH = "ACTIVITY_HTML5_PATH";
}
