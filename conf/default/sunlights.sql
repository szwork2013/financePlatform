...
CREATE SEQUENCE "public"."src"
 ...
 START 240
 CACHE 1;
SELECT setval('"public"."src"', 240, true);
...
"bank_code" varchar(100) COLLATE "default",
"bank_en_name" varchar(100) COLLATE "default",
"bank_name" varchar(40) COLLATE "default",
"bank_status" varchar(2) COLLATE "default",
"create_by" varchar(30) COLLATE "default",
"create_time" timestamp(6),
"deleted" varchar(1) COLLATE "default",
...
"id" int8 NOT NULL,
"code_abbr" varchar(255) COLLATE "default",
"code_cat" varchar(255) COLLATE "default",
"code_seq" numeric(19,2),
...
"fund_is_apply" int4,
"fund_is_redemption" int4,
"listed_date" timestamp(6),
"listed_sector" int4,
"listed_state" int4,
"fund_lowest_redemption" int8,
"fund_mill_profit" numeric(19,2),
"fund_min_apply" numeric(19,2),
"fund_nav" timestamp(6),
"fund_week_profit" numeric(19,2),
"fund_year_profit" numeric(19,2),
"fund_status" int4,
...
"product_name" varchar(100) COLLATE "default",
"product_code" varchar(30) COLLATE "default",
...
-- ----------------------------
-- Primary Key structure for table bar
-- ----------------------------
