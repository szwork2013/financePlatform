...
(
  ...
  type character(1), -- 1:申购 2:赎回 3:分红
  trade_status character(1), -- 1：存/取钱中、2：存/取钱成功、3：存/取失败【失败原因】
  confirm_status character(1), -- 0-不需发送；1-待确认；2-待确认；3-部分确认；4-确认完成；5-确认失败
  ...
  pay_status character varying(1),
