...
public class ProductServiceImpl implements ProductService {
    ...
    public List<FundVo> findProductRecommends(PageVo pager) {
        ...
        sql.append(" and r.begin_date <= '" + CommonUtil.dateToString(date, CommonUtil.DATE_FORMAT_LONG) + "'");
        sql.append(" and r.end_date > '" + CommonUtil.dateToString(date, CommonUtil.DATE_FORMAT_LONG) + "'");
        sql.append(" and r.temp_stop_date > '" + CommonUtil.dateToString(date, CommonUtil.DATE_FORMAT_LONG) + "'");
